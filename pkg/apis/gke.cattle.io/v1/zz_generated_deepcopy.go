...
func (in *GKEClusterConfigSpec) DeepCopyInto(out *GKEClusterConfigSpec) {
	*out = *in
	...
	if in.GKEClusterNetworkConfig != nil {
		in, out := &in.GKEClusterNetworkConfig, &out.GKEClusterNetworkConfig
		*out = new(GKEClusterNetworkConfig)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GKEClusterNetworkConfig) DeepCopyInto(out *GKEClusterNetworkConfig) {
	*out = *in
	if in.Network != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GKEClusterNetworkConfig.
func (in *GKEClusterNetworkConfig) DeepCopy() *GKEClusterNetworkConfig {
	if in == nil {
		return nil
	}
	out := new(GKEClusterNetworkConfig)
